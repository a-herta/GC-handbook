...
import { Quality, ItemType, ItemCategory, SceneType } from './types'
import type { MainQuest, Command, Avatar, Item, Scene, Entity, Quest } from './types'
...
export function getMainQuests(): MainQuestDump {
  ...
  mainQuests.forEach(e => {
    const quest = e as MainQuest
